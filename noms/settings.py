"""
Django settings for noms project.
...
if ENV == 'DEV':
    SECRET_KEY = 'django-insecure-__z+%ikgslm#_-d#&1gkoo*!gc68y^io*)skna4&uw)r_y-tpi'
else: 
...
WSGI_APPLICATION = 'noms.wsgi.application'
